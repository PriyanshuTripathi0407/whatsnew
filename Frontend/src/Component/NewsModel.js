    ...
    <div className='modal-overlay'>
        <div className='modal-content'>
            ...
            {article && (
              ...
              <p className='modal-date'>{new Date(article.publishedAt).toLocaleString('en-US', {month:'short',day:'2-digit',year:'numeric',hour:'2-digit',minute:'2-digit',second:'2-digit'})}</p>
